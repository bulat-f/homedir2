...
rm_cmd='rm -Rf bulat-f-homedir2-*'
cd_cmd='cd `ls -d bulat-f-homedir2*`'
deploy_cmd=" ${rm_cmd}; ${env_cmd} wget http://github.com/bulat-f/homedir2/tarball/master -O homedir2.tar.gz && ${env_cmd} tar zxf homedir2.tar.gz && ${cd_cmd} && pwd && ${env_cmd} ./install.pl ${flags} remote"
